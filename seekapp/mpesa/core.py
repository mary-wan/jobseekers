...
class MpesaClient:
    ...
    def c2b_payment(self, phone_number, amount, transaction_desc, callback_url, occassion, command_id):
        """
    ...
    def business_payment(self, phone_number, amount, transaction_desc, callback_url, occassion):
        ...
        return self.c2b_payment(phone_number, amount, transaction_desc, callback_url, occassion, command_id)
